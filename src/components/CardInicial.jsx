...
export function CardInicial( {setNotaAvaliacao, notaAvaliacao, setSubmited } ) {
    ...
    return (
        <div className="bg-gradient-dark text-white mx-6 p-6 rounded-2xl font-overpass max-w-103">
            ...
            <h1 className="text-2xl font-bold mb-2.5 text">How did we do?</h1>
            ...
            <button onClick={handleSubmit} className="bg-orange w-full uppercase trackng-1 font-bold rounded-3xl text-sm py-3 hover:bg-white hover:text-orange cursor-pointer duration-500">Submit</button>
        </div> 
    )
}